        ...
        <div className='custom_container'>
            ...
            <div className='col-span-4'>
                    <div className='flex flex-col lg:justify-between  relative  h-full lg:text-start text-center'>
                        <img src={'/assets/images/logo-tribeca.webp'} alt='tribeca logo'  className='lg:mb-0 md:mx-[0] mx-auto   w-[200px]  inline-block mb-8' height={'54'} width={'276'}/>
                        ...
                        India’s Leading <span className='lg:block'></span>  Trophy Property <span className='lg:block'></span>Developer
                              ...
                              <img src="/assets/images/circle_blob.webp"  alt="building blob" height={800} width={800} className='lg:hidden block absolute  right-[-80px] top-[-140px] opacity-[.4] w-full  w-[38%]' /> 
                    </div>
                </div>
                <div className='col-span-4'>
                    <img src={'/assets/images/tribeca_banner.webp'} className='rounded-lg' alt='tribeca banner' height={'589'} width={'682'}/>   
                </div>
